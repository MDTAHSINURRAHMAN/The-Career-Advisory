...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center font-lora text-center">
      <Helmet>
        <title>The Career Advisory | Login</title>
      </Helmet>
      <div className="card bg-base-100 w-full max-w-lg shrink-0 rounded-none p-2 md:p-5 lg:p-10 shadow-xl">
        <h2 className="text-2xl md:text-4xl font-semibold">Login Your Account</h2>
        ...
        <p className="text-sm md:text-base text-center font-semibold">
          ...
          <Link className="text-sm md:text-base text-blue-500 hover:underline ml-1" to="/auth/register">
            Register
          </Link>
        </p>
      </div>
